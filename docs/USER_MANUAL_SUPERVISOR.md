...
- Drop comments. Every comment also marks the task as "updated" for the other team members (they'll see a blue ring around the card next time they visit Tasks). Hover a comment to **Edit** or **Delete** your own (edited ones show **(edited)**); supervisors/admin who can write the student may also delete anyone's comment for moderation.
